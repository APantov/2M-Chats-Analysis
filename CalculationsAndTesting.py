...
df = spark.read.parquet("/user/s2853418/proj/sentiment_analysis_per_conversation.parquet")

#explodes the dataframe to acess element "openai_moderation" in column array
exploded_df = df.withColumn("element", explode(col("openai_moderation")))
...
>>>>>>> fbacadbf7cd01389959a59f33703ca936657081c
